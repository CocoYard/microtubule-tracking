...
def detectLine(img, line):
    ...
    thres = (img[pix1[0]-5:pix1[0]+5,pix1[1]-5:pix1[1]+5].mean()+img[pix2[0]-5:pix2[0]+5,pix2[1]-5:pix2[1]+5].mean())/2
    ...
    return im, end_points, skeleton, thres_img
